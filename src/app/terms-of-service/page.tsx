							...
							<div className="terms-of-service-content">
								...
								<blockquote className="blockquote">
									<p>
										...
										platforms you connect with eDemy. We
								...
								<ul>
									...
									<li>
										...
										Adobe’s LSOs through their Website
									...
									<li>
										...
										Advertising Alliance, or if you’re
										located in the European Union, visit the
										Your Online Choices site. To opt out of
										Google’s display advertising or
										customize Google Display Network ads,
										visit the Google Ads Settings page. To
										opt out of Taboola’s targeted ads, see
